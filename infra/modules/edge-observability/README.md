...
The module also creates API access logs, WAF IP rate limiting, 50%/80%/100% of a US$5 budget, essential alarms, and a dashboard. `ApiInvokerRole` is assumable only by supplied principals and grants `execute-api:Invoke` only.
