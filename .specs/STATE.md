...
- **Phase / Task**: Phase 2 / T12 - reservation cancellation endpoint
- **Completed**: T01 (`37e45ca`), T02 (`ae2efcc`), T03 (`e055f13`), T04 (`fbab81e`), T05 (`6a1fd2e`), T06 (`0f8054c`), T07 (`3bea022`), T08 (`80cdb2e`), T09 (`523795c`), T10 (`434d88c`), T11 (this commit)
- **In-progress** (file:line): none
- **Next step**: Implement T12 after this commit.
